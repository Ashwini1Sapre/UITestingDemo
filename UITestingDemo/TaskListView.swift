...
struct TaskListView: View {
  ...
  @State var todoItems = ["Make LIst", "Publish LIst", "Profit LIst"]
  ...
  var body: some View {
    ...
    NavigationView {
      ...
      .navigationBarItems(trailing: Button(action: {
        ...
        .sheet(isPresented:$shouldPresentModal, content: {          AddNewItemModal(isPresented: self.$shouldPresentModal, itemAdded: { newItem in
